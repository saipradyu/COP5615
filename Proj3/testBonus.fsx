...
let pastryBehaviour numNodes numRequests id maxRows (Nodelist:int List) (inbox: Actor<Message>) =
    let currNodeID = id
        ...
        actor {
            ...
            | NodeDie ->
                for node in Nodelist do
                    ...
                    currNode <! PoisonPill.Instance //TODO :RECHECK
...
let masterBehavior numNodes numRequests numFailingNodes (inbox: Actor<Message>) =
    ...
    for i=0 to numNodes-1 do
        ...
        printfn "name %s" name
        spawn system name (pastryBehaviour numNodes numRequests nodeIDInt maxRows Nodelist) |>ignore    
